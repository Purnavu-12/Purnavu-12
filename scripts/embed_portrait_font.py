...
The portrait is a one-off artifact — a photo pushed through a character ramp — so
unlike the stat graphics it isn't regenerated on a schedule. Run this after
ever rebuilding it.
...
geometry is unchanged, but a viewer whose default monospace is narrower — Consolas
is about 0.55 — would otherwise see the portrait roughly 7% too narrow.
