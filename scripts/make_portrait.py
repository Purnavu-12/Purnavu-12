...
Two things decide whether the output is any good:
...
Otherwise a viewer whose default monospace is narrower — Consolas is ≈0.55 — sees the portrait about 7% too narrow.
